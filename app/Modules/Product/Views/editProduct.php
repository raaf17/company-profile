<div class="container-fluid px-4">
  <div class="d-sm-flex align-items-center justify-content-between mb-2">
    <h1 class="h3 mb-2 text-gray-800"><b>Ubah Data Produk</b></h1>
  </div>
  ...
  <div class="card shadow mb-4">
    ...
    <div class="card-body">
      ...
      <form action="<?= site_url('product/updateProduct/'.$product_list->id_product) ?>" enctype="multipart/form-data" method="POST">
        <?= csrf_field(); ?>
        <!-- <input type="hidden" method="_method" value="PUT"> -->
        <input type="hidden" name="oldImage" value="<?= $product_list->image ?>">
        <div class="row">
          <div class="mb-3 col-6">
            <label for="product_name">Nama Produk</label>
            <input type="text" name="product_name" id="product_name" class="form-control <?= $validation->hasError('product_name') ? 'is-invalid' : null ?>" value="<?= old('product_name', $product_list->product_name) ?>">
          ...
          <div class="mb-3 col-6">
            ...
            <select name="category_slug" id="category_slug" class="form-control <?= $validation->hasError('category_slug') ? 'is-invalid' : null ?>">
              ...
              <?php foreach ($category_product as $category) : ?>
                <?php if (old('category_slug', $product_list->category_slug) == $category->category_name) : ?>
        ...
        <div class="mb-3">
          ...
          <textarea name="description" id="description" cols="30" rows="10" class="form-control <?= $validation->hasError('description') ? 'is-invalid' : null ?>"><?= old('description', $product_list->description) ?></textarea>
        ...
        <div class="mb-3 col-6">
          ...
          <?php endif; ?>
          <img src="<?= base_url('asset_admin/img/'.$product_list->image) ?>" alt="..." class="preview-img mt-2" width="100px">
        </div>
